            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 15) {
                    Toggle("댓글", isOn: $viewModel.commentNotification)
                        ...
                        .tint(.SBTitle)
                        .padding(.horizontal)
                    Text("다른 사용자가 여러분의 글에 댓글을 작성하면 백그라운드 상태에서도 알림을 받을 수 있어요")
                        .font(.system(size: 12))
                    ...
                    Toggle("좋아요", isOn: $viewModel.likeNotification)
                        ...
                        .tint(.SBTitle)
                        .padding(.horizontal)
                    Text("다른 사용자가 여러분의 글에 좋아요를 누르면 백그라운드 상태에서도 알림을 받을 수 있어요")
                        .font(.system(size: 12))
                        .foregroundStyle(.gray)
                        .padding(.horizontal)
                    Divider()
                    ...
                    Toggle("팔로우", isOn: $viewModel.followNotification)
                        ...
                        .tint(.SBTitle)
                        .padding(.horizontal)
                    Text("다른 사용자가 여러분을 팔로우하면 백그라운드 상태에서도 알림을 받을 수 있어요")
                        .font(.system(size: 12))
                        .foregroundStyle(.gray)
                        .padding(.horizontal)
                }
