...
struct HomeBookDetailView: View {
    @Bindable var viewModel: HomeBookViewModel
...
#Preview {
    HomeBookDetailView(viewModel: HomeBookViewModel(book: Book.DUMMY_BOOK))
}
